...
- Gradient Able Free
  - [Live Preview](https://codedthemes.com/homes/admin-templates/gradient-able/angular/free)
  - [Download](https://github.com/codedthemes/gradient-able-free-admin-template)
- Gradient Able Pro
  - [Live Preview](https://codedthemes.com/homes/admin-templates/gradient-able/angular/default/)
...
| [Gradient Able Free](https://codedthemes.com/homes/admin-templates/datta-able/react/free)             | [Gradient Able Pro](https://codedthemes.com/homes/admin-templates/datta-able/react/default) |
| ----------------------------------------------------------------------------------------------------- | :------------------------------------------------------------------------------------------ |
| **12** home pages                                                                                     | **100+** home pages                                                                         |
| -                                                                                                     | ✓ Multi-language                                                                            |
| -                                                                                                     | ✓ Dark/Light Mode 🌓                                                                        |
| -                                                                                                     | ✓ TypeScript version                                                                        |
| -                                                                                                     | ✓ 6+ color Options                                                                          |
